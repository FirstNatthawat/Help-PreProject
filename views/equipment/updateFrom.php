...
<div class="col-6">
    <div class="card">
        <div class="card-body">
            <h4 class="header-title">อัปเดตอุปกรณ์</h4>

            <form method="get" action="">
<input type="hidden"name="equipment_id"value ="<?php echo $equipment->equipment_id; ?>"/><br>
    
    <label>category_equipment <select name = "categoryequipment_id" >
        <?php
